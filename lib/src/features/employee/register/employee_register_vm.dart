...
class EmployeeRegisterVm extends _$EmployeeRegisterVm {
  ...
  void addOdRemoveWorkDays(String weekDay) {
  ...
  void addOdRemoveWorkHour(int hour) {
  ...
  Future<void> register({String? name, String? email, String? password}) async {
    ...
    final IUserRepository(:registerAdmAsEmployee, :registerEmployee) = ref.read(userRepositoryProvider);
    ...
    switch (resultRegister) {
      case Success():
        state = state.copyWith(status: EEmployeeRegisterState.success);
      case Failure():
        state = state.copyWith(status: EEmployeeRegisterState.error);
    }
